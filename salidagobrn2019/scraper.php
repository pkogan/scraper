<?php
//$urloficial='https://rionegro.datosoficiales.com/resultados/';
$urloficial='https://www.jusrionegro.gov.ar/web/institucional/tribunal-electoral/resultados/2019/abril/resultados/';
...
foreach ($ubicaciones as $key => $value) {
    if($value['clase_ubicacion']=='Mesa'){
        ...
        $url=$urloficial. str_replace('.', '/', $value['id_ubicacion']).'/LRC.json';//'/RPO.json';//'/CNJ.json';
